...
FWKs are currently only available in 15–20 litre minimum volumes — a deliberate constraint of the commercial production process. This makes splitting between club members a necessity for small-batch brewing, and is exactly why BrewClub is structured around a club format. A 10-litre FWK option would open small-batch brewing to solo brewers without the need to split. This is an acknowledged gap in the market. If you're a supplier or producer reading this, we'd love to hear from you — [open an issue on GitHub](https://github.com/r-colvin/craftbrewer.se).
:::
