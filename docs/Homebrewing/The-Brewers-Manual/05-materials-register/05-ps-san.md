...
Enolandia's product photograph of the compact airlock shows a distinct bluish tinge — consistent with GPPS, which in thin sections can show a faint blue cast due to light scattering in the amorphous matrix. SAN in thin sections tends toward a very slight yellow. This is not conclusive identification, but it is a weak signal toward GPPS.
