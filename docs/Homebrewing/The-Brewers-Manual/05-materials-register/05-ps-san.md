...
This page covers two chemically related but practically different materials. General-purpose polystyrene (GPPS) is an amorphous, rigid, transparent polymer — inexpensive, widely used, and chemically vulnerable to the surfactant component of ABNS sanitisers. Outside brewing it is found in CD jewel cases, disposable cutlery, yoghurt pots, and cheap transparent packaging. Styrene-acrylonitrile copolymer (SAN) is a copolymer of styrene and acrylonitrile — similarly transparent and rigid, but the acrylonitrile content substantially improves its chemical resistance, including to ABNS. Outside brewing, SAN is used for transparent kitchenware, measuring jugs, mixing bowls, and refrigerator components where better chemical resistance is needed. Both are visually indistinguishable in service. In homebrewing, only one piece of equipment has been confirmed as PS: the [Enolandia compact 2-piece airlock](https://www.enolandia.it/en/prodotto/air-lock-compact-medium-for-container-up-to-60lt-2/). As of writing, which type of PS is unknown.
...
**Primary observation — brief IPA contact.** One minute of 70% IPA contact (towel application to the stem) produced no visible or tactile change on either of two Enolandia airlocks tested (compact 2-piece and bubbler) — no hazing, no crazing, no change in surface feel. This is consistent with the **B** rating for brief [DES](#compatibility--des-gpps-b-san-a) contact on GPPS and with Enolandia's manufacturer compatibility claim for ethanol. It does not extend to sustained immersion, and it does not resolve the GPPS vs SAN grade question — both materials would survive brief IPA contact at this timescale.
