...
Among the most thoroughly regulated food contact materials in the world. [EU Regulation 10/2011](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02011R0010-20230923) lists PET with specific migration limits for its monomers: terephthalic acid (SML 7.5 mg/kg) and ethylene glycol (SML 30 mg/kg).[^1]

The most important contextual fact for PET compatibility: PET is used globally at scale for carbonated beverages including beer, sparkling water, and cola — all of which are more aggressive contact environments than working-dilution ABNS. A PET bottle of cola contacts phosphoric acid at pH 2.5 for weeks on a warm retail shelf. Working-dilution ABNS at pH 3.0–3.5 for 30–60 seconds is a substantially less demanding scenario.
