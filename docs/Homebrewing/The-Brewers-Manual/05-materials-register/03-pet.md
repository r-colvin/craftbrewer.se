...
Choosing between packaging options — standard PET, Oxebar, glass, or stainless keg — is covered in the [packaging guide](../Packaging/01-choosing-packaging.md).

### PET vs PP and HDPE as fermentation vessels

Oxygen ingress is not just a packaging concern — it also matters during fermentation and conditioning when beer sits in the vessel for weeks. This is where PET offers a meaningful advantage over PP and HDPE fermenters. KegLand state explicitly that the FermZilla's PET wall is [a better gas barrier than PP or HDPE](https://docs.kegland.com.au/products/fermentation-equipment/fermzilla-all-rounder-30l-and-60l-user-guide),[^kl-fermzilla-guide] and that HDPE fermenters can be porous enough to carry flavour and aroma from one batch to another.[^kl-fermzilla-product] Standard PET OTR is already substantially lower than HDPE at typical wall thicknesses; the practical implication for a homebrewer keeping beer in a fermenter for 2–4 weeks is real, if modest. For closed-transfer brewing with pressure fermentation and kegging, PET's oxygen barrier is a genuine advantage over HDPE or PP buckets.
...
:::caution Pressure vessel safety — applies to all materials
This section discusses structural failure risk in the context of PET, but **the underlying safety principles apply to all pressurised vessels regardless of material** — [PET fermenters](../Equipment/02-fermzilla-all-rounder.md) and [PET bottles](../Equipment/04-bottles-and-bottling.md) (this page), [glass bottles](../Equipment/04-bottles-and-bottling.md) ([material](./20-glass.md)), [stainless kegs](../Equipment/05-cornelius-kegs.md) ([material](./19-stainless.md)). Pressure vessel failure can cause serious injury. The material determines how and when failure may occur; the consequences of failure are determined by the pressure stored. This topic is covered on each relevant material page and in the equipment guides. A dedicated pressure safety overview is planned.
:::
...
**Hydrostatic testing.** KegLand strongly recommends periodic hydrostatic testing of both [Oxebar kegs](https://kegland.com.au/products/4l-oxebar-multilayer-keg-with-cap-and-handle-pco38)[^kl-oxebar] and FermZilla pressure fermenters — every two years, with a full test procedure in their [Hydro Test Guide](https://docs.kegland.com.au/products/fermentation-equipment/fermzilla-all-rounder-30l-and-60l-user-guide/hydro-test-guide).[^kl-hydro-test] The test is done with the vessel filled to the brim with water (not CO₂ or air — water is incompressible, so a failure during the test is safe). Given the low cost of Oxebar kegs, replacing them on the two-year schedule rather than retesting is a reasonable alternative. For FermZilla fermenters, note that the tank has a stamped date — do not use under pressure past that date without hydrotesting first.
...
**UV embrittlement.** [KegLand explicitly note](https://kegland.com.au/products/fermzilla-30l-all-rounder-pressure-rated-keg-fermenter-now-with-stainless-handle) that FermZilla vessels must be kept out of direct sunlight.[^kl-fermzilla-product] UV degrades PET progressively through photo-oxidation: the surface yellows, becomes brittle, and loses mechanical strength. A yellowed or brittle PET vessel stored in direct sunlight should not be used under pressure. Amber-tinted PET (Oxebar 20L) has better UV resistance — but the same principle applies: store all PET equipment away from direct sunlight as a matter of routine.
...
[^kl-hydro-test]: KegLand, [*FermZilla All-Rounder Hydro Test Guide*](https://docs.kegland.com.au/products/fermentation-equipment/fermzilla-all-rounder-30l-and-60l-user-guide/hydro-test-guide). Full test procedure: fill vessel to brim with water, pressurise to 4.0 bar (60 PSI) using regulated water or CO₂ source, hold 1 minute. Use grey 6.5 bar PRV during test; swap back to red 2.5 bar PRV immediately after. FermZilla has a stamped date 24 months after manufacture — do not use under pressure past this date without passing a hydro test.

[^kl-fermzilla-guide]: KegLand, [*FermZilla All-Rounder User Guide*](https://docs.kegland.com.au/products/fermentation-equipment/fermzilla-all-rounder-30l-and-60l-user-guide). Accessed May 2026. Direct quote: “The PET plastic is not permeable like some other fermenters made from PP or HDPE. The fermenter wall is a much better gas barrier keeping your product fresher for longer.”

[^kl-fermzilla-product]: KegLand, [*FermZilla 30L All-Rounder product page*](https://kegland.com.au/products/fermzilla-30l-all-rounder-pressure-rated-keg-fermenter-now-with-stainless-handle). Accessed May 2026. Direct quote: “Other HDPE fermenters tend to be so porous they carry flavour and aroma from one batch to another.”
