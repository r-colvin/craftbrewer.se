...
- **Force-carbonated keg:** regulated pressure, typically 10–15 PSI at serving temperature. Controlled by the gas regulator (which has its own PRV) and the keg's own PRV. Constant and well-bounded.
- **Pressure-fermented FermZilla:** CO₂ generated by fermentation, controlled by a spunding valve set to the target pressure and a PRV as a safety ceiling (typically 10–15 PSI). Both devices together keep pressure within a defined, safe range throughout fermentation.
