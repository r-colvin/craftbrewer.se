...
Look for the <GlossaryTerm term="RIC">Resin Identification Code</GlossaryTerm> moulded into the base of the article -- three chasing arrows forming a triangle, with the number **1** inside and **PET** or **PETE** below.
...
<div style={{display:'flex', alignItems:'flex-start', gap:'1.25rem', margin:'0.75rem 0'}}>
  <div style={{background:'#ffffff', borderRadius:'6px', padding:'8px', flexShrink:0, lineHeight:0}}>
    <ResinCode code={1} abbr="PET" size={72} />
  </div>
  <div style={{fontSize:'0.9rem'}}>
    <p style={{marginTop:0, marginBottom:0, color:'var(--ifm-font-color-secondary)', fontStyle:'italic'}}>The RIC 1 symbol as it appears on the base of <a href="/glossary#pet">PET</a> articles.</p>
  </div>
</div>

<small style={{color:'var(--ifm-color-emphasis-500)', fontSize:'0.72rem'}}>
  RIC symbol: Anton Poliakov, <a href="https://commons.wikimedia.org/w/index.php?curid=82815775" target="_blank" rel="noopener noreferrer">Wikimedia Commons</a>, <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener noreferrer">CC BY-SA 4.0</a>. Modified: fill colour adapted for dark-mode display.
</small>
...
Under [EU Regulation 10/2011](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02011R0010-20230923), PET is a positively listed polymer with established <GlossaryTerm term="SML">specific migration limits</GlossaryTerm> for its monomers: terephthalic acid (<GlossaryTerm term="SML">SML</GlossaryTerm> 7.5 mg/kg) and ethylene glycol (<GlossaryTerm term="SML">SML</GlossaryTerm> 30 mg/kg). Both monomers have well-characterised toxicology profiles and are tested routinely in food contact applications.
...
For Oxebar barrier PET, the inner PET surface governs food contact compliance; the barrier additives or barrier layers are not in food contact.
...
For Oxebar barrier PET, [KegLand's stated maximum is 45 °C](https://kegland.com.au/products/4l-oxebar-multilayer-keg-with-cap-and-handle-pco38)[^kl-oxebar], but cleaning practice should remain at 40 °C -- the barrier polymer matrix or inter-layer bond is at additional risk from elevated temperature, and the 5 °C margin provides no justification for relaxed discipline.
...
PET's <GlossaryTerm term="HDT">heat deflection temperature</GlossaryTerm> under load sits in the range 65--80 °C depending on grade and crystallinity. Near-boiling wort causes immediate, irreversible deformation. Wort at 50--60 °C poses a deformation risk under the internal pressure of a sealed vessel even before the HDT is reached.

**No-chill brewing is not compatible with PET.** No-chill relies on transferring hot wort directly into a sealed vessel and allowing it to cool slowly. This exposes the vessel wall to temperatures that will degrade PET. For no-chill-compatible vessel materials, see the [no-chill process page](../Processes/02-no-chill.md). PET vessels should not be adapted for no-chill use regardless of design.

:::note Comparison to polyolefins
...
## Compatibility -- ABNS: A {#compatibility--abns-a}
...
<GlossaryTerm term="DES">DES</GlossaryTerm> (ethanol-based sanitiser) at 70--80% has no meaningful interaction with PET at typical contact times. PET is rated for ethanol at all concentrations encountered in homebrewing use. No concern.

## Compatibility -- cleaning: A† {#compatibility--cleaning-a}

PET has the most complex cleaning compatibility profile in this register. The three cleaner categories behave differently. The constraints on PET pressure fermenters and kegs are stricter than for plain PET bottles, but the reason is not the PET material itself -- it is geometry and mechanical stress. A PET soda bottle stores carbonated beer without issue. The difference with a pressure fermenter is one of stress geometry and sustained mechanical load: pressure vessel fittings -- threaded ports, lid threads, O-ring seats under torque -- create [Zone B geometry](../04-wdc-model.md#zone-b--confined-geometry) where cleaner can concentrate and dwell, and sustained CO₂ pressure creates <GlossaryTerm term="ESC">ESC</GlossaryTerm>-relevant mechanical stress. A PET bottle does have a threaded neck and geometric transitions, but it operates at lower sustained pressure, the thread is single-use or low-cycle, and there are no O-ring interfaces under sustained compression. The risk profile differs in degree, not in kind.
...
All current Oxebar keg products -- 4L, 8L, and 20L -- appear to use the same blended PET construction: a PET polymer blend with barrier additives giving approximately 3x better oxygen barrier than standard PET, recommended for up to 6 months storage. KegLand use at least three names for this across their product pages: **Oxebar Mono**, **Oxebar Monolayer**, and **Mono Barrier PET Polymer Matrix**. These are the same thing.

A fourth description -- **Oxebar Multi-Layer** -- appears on a 4L ball lock draught pack product page, where KegLand describe a triple-layer EVOH construction suitable for up to 10--12 months storage. Whether this represents a genuinely distinct product or historical terminology inconsistency is not clearly established from available sources. If ordering specifically for long-term storage of sensitive styles, confirm the product description explicitly states the triple-layer or EVOH construction before purchasing.
:::

The [Oxebar range](../Equipment/03-oxebar-mini-keg.md) from KegLand addresses oxygen ingress directly through the material construction.[^kl-oxebar-multilayer]

**[Oxebar](https://kegland.com.au/products/4l-oxebar-multilayer-keg-with-cap-and-handle-pco38)** ([KegLand EU](https://kegland.eu/products/4l-oxebar-multilayer-keg-with-cap-and-handle-pco38)) -- a blended PET polymer with barrier additives, approximately 3x better oxygen barrier than standard PET. Available in [4L](https://kegland.com.au/products/4l-oxebar-multilayer-keg-with-cap-and-handle-pco38), [8L](https://kegland.com.au/products/8l-oxebar-mono-polymer-keg-with-cap-and-handle), and [20L](https://kegland.com.au/products/oxebar-20l-amber-pet-keg-pressure-fermenter-tank). KegLand recommend up to 6 months storage. This is the standard current Oxebar product under whatever name appears on the product page.

A separate [4L ball lock draught pack](https://kegland.com.au/products/4l-oxebar-multilayer-keg-ball-lock-tapping-draught-pack-pco38) is described by KegLand as using a triple-layer EVOH construction suitable for up to 10--12 months storage. Whether this is a genuinely distinct current construction or legacy naming is not clearly established. If this storage duration matters for your beer, confirm the product description before ordering.
...
## Barrier PET -- Oxebar construction and cleaning {#multilayer-pet--oxebar}

The Oxebar construction variants and their implications for cleaning compatibility are covered here. Barrier performance and packaging choice are discussed under [Oxygen ingress](#oxygen-ingress) above.

### Construction

Oxebar (Mono/Monolayer) uses a blended PET polymer matrix with barrier additives; it is a single-layer construction. A separate product described as Oxebar Multi-Layer uses a triple-layer laminate with an EVOH oxygen barrier layer sandwiched between two PET skins. EVOH loses its barrier properties when wet; in the laminated construction it is never directly exposed to liquid. The inner PET layer is the food contact surface in both constructions.

### Chemical compatibility

The food contact surface in any Oxebar vessel is the inner PET layer. Chemical compatibility analysis is identical to plain PET: the same 40 °C temperature limit, the same cleaner ratings, the same ABNS profile. For the blended Mono construction, the barrier additives are within the PET matrix and not in food contact. For the Multi-Layer construction if it exists as a distinct product, the EVOH layer's own chemical compatibility is not relevant because it never contacts the product or cleaning solutions.

### The additional constraint for barrier constructions

The Oxebar blended polymer matrix and any inter-layer bond in a Multi-Layer construction are sensitive to elevated temperature. This is an additional, independent reason to hold strictly to 40 °C maximum for Oxebar cleaning, separate from the plain-PET hydrolysis concern. KegLand's stated 45 °C maximum[^kl-oxebar] is a ceiling, not a target.
...
|---|---|---|---|---|
| **[PET beer bottles](../Equipment/04-bottles-and-bottling.md)** | RIC 1 confirmed. DoC obtainable from packaging supply chains. | 40 °C max cleaning; no hot wort or hot fill. | [Zone A](../04-wdc-model.md#zone-a--open-surfaces) -- low concern at interior surfaces. | StellarOxy preferred; StellarClean ≤30 min; Five Star PBW A\* with same limit. |
...
| **[Oxebar keg](../Equipment/03-oxebar-mini-keg.md)** | Barrier PET polymer blend; food grade claim by manufacturer. | 40 °C max. | [Zone B](../04-wdc-model.md#zone-b--confined-geometry) at fittings; same as fermenter. | Same as PET fermenter. KegLand video guidance: 15 min max soak.[^kl-oxebar-video] |
...
[^kl-oxebar-multilayer]: KegLand, [*4L Oxebar Keg -- Ball Lock Tapping Draught Pack*](https://kegland.com.au/products/4l-oxebar-multilayer-keg-ball-lock-tapping-draught-pack-pco38). Accessed April 2026. Describes triple-layer PET and oxygen barrier construction; up to 10--12 months storage recommended. Whether this is a distinct current construction or legacy naming is not confirmed.

[^kl-oxebar-video]: David Heath / KegLand, *Oxebar Mini Keg -- How to Clean* (YouTube), [youtube.com/watch?v=ikk99JCE3pM](https://www.youtube.com/watch?v=ikk99JCE3pM&t=1). Accessed April 2026. Direct quote at 0:01: *"Do not over-soak: Limit detergent contact to a maximum of 15 minutes to protect the plastic."* Also confirms: no bleach or high-caustic cleaners; no sodium metasilicate at extended contact.
