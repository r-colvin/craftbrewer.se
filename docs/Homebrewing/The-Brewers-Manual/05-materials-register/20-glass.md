...
Glass appears in homebrewing as airlocks, test jars, hydrometer cylinders, fermenters (carboys), and bottles.
...
One counterintuitive finding from recent research: glass bottles have measured higher microplastic content than PET bottles in some studies, including [ANSES 2025 data](https://www.anses.fr/). The source is environmental contamination during manufacturing and filling, not migration from the glass itself. This does not affect the food contact or chemical compatibility rating of glass, but it is relevant context for the microplastics discussion — see [Microplastics](../07-microplastics.md).
