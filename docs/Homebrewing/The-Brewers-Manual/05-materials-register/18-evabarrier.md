...
The EVOH core layer's primary limitation is moisture sensitivity — sustained water exposure can temporarily reduce its oxygen barrier performance. In a beer line in normal service, this is not a concern: the line is in contact with beer (not water) and is periodically cleaned and dried. The low-oxygen-transmission benefit of the EVOH core is intact under normal use conditions.
