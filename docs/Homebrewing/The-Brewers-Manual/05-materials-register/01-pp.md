...
:::tip Summary
**PP is safe for all normal homebrewing use.** Sanitise with ABNS or DES, clean with any standard alkaline cleaner, ferment any style including high-ABV and sour. No special precautions are needed for bucket bodies, lids, airlocks, or funnels — these are all Zone A geometry where WDC accumulation is low and PP-the-material has no chemical vulnerability to any homebrewing chemical at realistic concentrations.

**The limits that matter are structural, not chemical:** the Witre bucket's maximum continuous use temperature is 40 °C — normal fermentation is well within this, but no-chill brewing (wort cools above 40 °C for 12–14 hours) is not appropriate for a PP bucket. Replace any bucket showing visible surface crazing, warping, or persistent staining. Buy food grade — it’s the norm at homebrewing retailers and the price difference is negligible.

The long sections below cover the chemistry, food grade compliance framework, and WDC accumulation analysis for readers who want the full picture. A summary by article type is at the [bottom of this page](#summary-by-article-type).
:::
...
**The limits that matter are structural, not chemical:** the Witre bucket’s maximum continuous use temperature is 40 °C — normal fermentation is well within this, but no-chill brewing (wort cools above 40 °C for 12–14 hours) is not appropriate for a PP bucket. Replace any bucket showing visible surface crazing, warping, or persistent staining. Buy food grade — it’s the norm at homebrewing retailers and the difference in price is negligible.

The long sections below cover the chemistry, food grade compliance framework, and WDC accumulation analysis for readers who want the full picture.
:::
