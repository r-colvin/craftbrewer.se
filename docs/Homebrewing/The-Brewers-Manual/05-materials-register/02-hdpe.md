...
The contrast with materials that do fail under ABNS WDC conditions is instructive — the [DuoTight case study](../case-studies/duotight.md) covers how POM fittings degraded through a combination of acid hydrolysis and DDBSA-driven ESC, and why neither mechanism applies to HDPE.
