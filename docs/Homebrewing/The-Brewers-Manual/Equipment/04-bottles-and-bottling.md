...
**Food contact status:** food-grade PET is *A*-rated for ABNS, DES, and alkaline cleaners within the temperature constraint (40°C maximum). [Regulation (EU) No. 10/2011](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02011R0010-20230923) covers PET as an authorised substance for food contact packaging.
...
**See also:** [Crown cap liners](../05-materials-register/23-crown-cap-liners.md) for the ABNS deactivation mechanism.
...
**Silicone transfer hose:** sanitise by boiling (25–35 minutes; silicone is rated for it), ABNS flow-through (30 seconds contact in the bore, then drain and use immediately), or DES flush (spray through the bore, drain, proceed). See [sanitising](../02-sanitising.md).
...
1. Clean and sanitise the fermenter tap (ABNS, no-rinse) and the bottling wand and hose (ABNS dip or DES flush).
2. Prepare bottles: rinse clean bottles with fresh water. Sanitise with ABNS fill-and-drain or DES spray-and-drain. Stand upright.
3. Drop carbonation drop into each dry bottle.
4. Fill from the bottom using the wand — wand tip seats on the bottle base; fill at low flow rate; remove wand as beer rises to neck, leaving 2–3 cm headspace.
5. Squeeze (PET only) before capping.
6. Cap immediately. For oxygen-scavenging caps: apply dry, do not pre-wet.
7. Label with batch number and date. Store at conditioning temperature (typically 18–20°C) for 2–3 weeks.
8. Transfer to fridge to clarify and slow conditioning. Test a bottle at 2 weeks; adjust conditioning time based on carbonation level.
